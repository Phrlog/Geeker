    ...
    <div class="navbar navbar-material-blog navbar-primary navbar-absolute-top">
        ...
        <div class="navbar-wrapper container">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?= Url::to(['geeks/index']); ?>"><i class="material-icons">&#xE871;</i>
                    Geeker
                </a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    <li class="active dropdown">
                        <a href="#" data-target="#" class="dropdown-toggle"
                           data-toggle="dropdown"><?= Html::encode($username) ?>
                            <b class="caret"></b></a>
                    ...
                    <li class="dropdown">
                        <a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Твиты <b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Пользователи <b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
